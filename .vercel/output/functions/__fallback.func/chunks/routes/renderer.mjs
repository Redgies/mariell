...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Mariell recrute les meilleurs Sales pour les meilleures entreprises. Des Sales qui chassent d'autres Sales."},{"name":"theme-color","content":"#000000"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"title":"Mariell — Recrutement Sales Premium","htmlAttrs":{"lang":"fr"}};
...
const getServerEntry = () => import('../build/server.mjs').then(function (n) { return n.h; }).then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
