...
**Statut** : V5 — nettoyage des sections obsolètes en fin de fichier (STATS V1, DIFFÉRENCES V0→V1, DEMANDES EXPLICITES V2). Aucun changement de fond — la calibration F4 V4 reste l'expertise terrain Mariell de référence.
