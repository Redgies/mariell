...
**Changements V9 → V10** :
- Ajout d'une **règle de cohérence métier stricte** en section 3 : matrice explicite poste recherché → familles d'intitulés autorisés/interdits (réponse au défaut "Account Manager proposé pour un poste de Business Developer")
- Ajout d'une **règle de dérivation forcée** en section 4 : la requête booléenne doit obligatoirement inclure tous les intitulés primaires cités en section 3 (réponse au défaut "intitulés cités en section 3 absents de la booléenne")
- Ajout d'un mini-bloc de vérification interne avant génération de la section 4
