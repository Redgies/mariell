...
// Synchronous cleanup: registering onBeforeUnmount AFTER an await inside
// onMounted fails (Vue loses the active instance), which silently halts
// the rest of the async block.
...
onMounted(async () => {
  ...
  // 3. Scroll-linked parallax on .scroll-parallax elements --------------------
