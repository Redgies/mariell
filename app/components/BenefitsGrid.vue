...
const benefitsAsym = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '<strong>On acquiesce quand il le faut, on challenge tout autant.</strong>',
    ],
  ...
  },
  {
    ...
    paragraphs: [
      "Poste vacant en Sales ? Du CA de perdu. Recherche qui dure ? Pareil.",
      "<strong>Mauvais recrutement ? Beaucoup trop de CA de perdu.</strong> <strong>Cash is king.</strong>",
    ],
  ...
  },
  {
    ...
    paragraphs: [
      "Notre expérience personnelle du métier Sales nous permet une évaluation critique. Aucun signal faible ne nous échappe.",
      "<strong>Track record impactant, intelligence émotionnelle et cognitive —</strong> <strong>c'est ce qu'on cherche, et qu'on identifie dans un contexte Sales.</strong>",
    ],
